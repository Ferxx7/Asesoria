...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (whatsappTrader) {
    whatsappTrader.setAttribute('href', waUrl('Hola, quiero info del Taller Técnico: Análisis y Trading Cripto (Q450).'));
    whatsappTrader.setAttribute('target', '_blank');
    whatsappTrader.setAttribute('rel', 'noopener');
  }
  if (whatsappInvestor) {
    whatsappInvestor.setAttribute('href', waUrl('Hola, quiero agendar la Asesoría Estratégica: Dólares Digitales (Q500).'));
